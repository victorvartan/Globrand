...
<div class="h-1/4 w-full">
    ...
    <form name="analyze-form" method="POST" action="?/analyze" class="mt-10 justify-center" use:enhance={async ({ formData }) => {
        ...
        <div class="flex justify-center mt-5">
            <LoadingButton type="submit" isLoading={isLoading} class="p-2 w-80 text-lg bg-transparent border rounded border-teal-700 focus:outline-none text-black dark:text-gray-300">
